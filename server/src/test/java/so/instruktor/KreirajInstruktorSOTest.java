...
/**
 * Test klasa za sistemsku operaciju {@link KreirajInstruktorSO}.
 * Testiraju se preduslovi sistemske operacije koji ne zahtevaju
 * konekciju na bazu podataka, kao i pocetne vrednosti atributa.
 *
 * @author Tijana
 * @version 1.0
 * @see KreirajInstruktorSO
 */
@DisplayName("Testovi za SO KreirajInstruktorSO")
public class KreirajInstruktorSOTest {

    private KreirajInstruktorSO so;
